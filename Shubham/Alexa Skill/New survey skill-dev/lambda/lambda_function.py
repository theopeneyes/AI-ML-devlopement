...
from utils import posting_responses,get_boolean,is_check_multiple_mcq,get_wrong_options,get_timezone_based_ty_msg
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        try:
            ...
            if attr["home_intent"]:
                speak_output = language_prompts["HOME_WELCOME_MESSAGE_PROMPT"]
                reprompt = language_prompts["HOME_WELCOME_MESSAGE_REPROMPT"]
            ...
            speak_output = language_prompts["WELCOME_MESSAGE_PROMPT"]
            reprompt = language_prompts["WELCOME_MESSAGE_REPROMPT"]
        ...
        if id_len == 6 :
            ...
            if str(codes) == "200":
                ...
                if survey_status_code == "200" :
                    ...
                    # Appending general feedback question in question list data
                    feedback_question_data = {
                        "question_text" : "Do you have any other thoughts or feedback you'd like to share about this survey?",
                        "rating" :  None,
                        "question_type_id" : "general_feedback",
                        "is_other" : 0,
                        "options" :  [],
                        "is_required" : 0
                        }
                        
                    datass.append({"question":feedback_question_data})
                    ...
                    speak_output = language_prompts["SURVEY_CLOSED_PROMPT"]
                    ...
                    speak_output = language_prompts["SURVEY_INTENT_FALBBACK_PROMPT"]
                ...
                try:
                    ...
                    pass
                speak_output = language_prompts["SURVEY_NOT_AVAILABLE_PROMPT"]
            ...
            try:
                ...
                pass
            speak_output = language_prompts["SURVEY_CODE_NOT_SIX_DIGIT"]
...
class QuestionIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if intent_lst[-1] != "AMAZON.ResumeIntent" and support_type_intent :
            ...
            speak_output = language_prompts["QUESTION_INTENT_SUPPORT_REPLY_INETNT"]
            return (
            handler_input.response_builder
            .speak(speak_output)
            .ask(speak_output)
        ...
        #If user report survey at any question in survey this block will execute and propmpt thank you message(Test this condition properly)
        elif report_survey_intent and intent_lst[-1] != "HelpExitIntent" and intent_lst[-1] != "AMAZON.ResumeIntent" and intent_lst[-1] != "AMAZON.CancelIntent" : #intent_lst[-2] == "ReportSurveyIntent"
            speak_output = language_prompts["QUESTION_INTENT_REPORT_SURVEY"]
            # Code for posting report survey comment to API
            report_survey_comment = user_response
            ...
            "question_id": "", 
            "question_type_id": "",
            "response_text": report_survey_comment,
            "question_option_id": "",
            "device_id": device_id }
        ...
        # IF user in help intent and user_response was other than help related options
            ...
            speak_output = language_prompts["QUESTION_INTENT_HELP_PROMPT"]
            return (
            handler_input.response_builder
            .speak(speak_output)
            .ask(speak_output)
        ...
        # Condition for handling responses other than number for Rating & GroupRating
            ...
            speak_output =  language_prompts["QUESTION_INTENT_INVALID_RATING_PROMPT"]
            return (
            handler_input.response_builder
            .speak(speak_output)
            .ask(speak_output)
        ...
        # Condition for Handling unwanted response for MCQ type question
            ...
            speak_output = language_prompts["QUESTION_INTENT_INVALID_MCQ_OPTION_1"]
            return (
            handler_input.response_builder
            .speak(speak_output)
            .ask(speak_output)
        ...
        # In MCQ with Other if user_response is "other"
            ...
            speak_output = language_prompts["QUESTION_INTENT_MCQ_OTHER_PROMPT"]
        ...
        # Condition for Handling unwanted response for MCQwithmultipleselection 
            ...
            if len(invalid_options_from_user) > 0 and len(invalid_options_from_user) <= 3:
                ...
                speak_output = (str(language_prompts["QUESTION_INTENT_INVALID_MCQ_OPTION_2"])).format(inavalid_options=invalid_options_str)
            else :
                speak_output = language_prompts["QUESTION_INTENT_INVALID_MCQ_OPTION_1"]
            return (
            handler_input.response_builder
        ...
        # This condition if user gave any feedback we will post that feedback msg to Feedback API and prompt Thank You msg
        # elif attr["feedback"] and attr["intent_history"][-2] == "FeedbackIntent":
        #     # we will take user answer and post it in feedback API and prompt thank you message 
        #     my_objs = {
        #     "isSurvey": 1,
        #     "name": "alexa",
        #     "email": device_id,
        ...
        #     "survey_id": main_survey_id,
        #     "platform_id": main_survey_id
        #     }

        #     # url = "https://openeyessurveys-api.devbyopeneyes.com/public/api/publicFeedbackRequest" 
        #     # headers = {'Content-Type':'application/json','Accept':'application/json','Authorization':'mNIPg8r7wMnOhnQByiX1KpwjHwz3CzCnr7O9hQY0uZ1AXcwGcFVnxApaFKIY6Rs0keYaaVyoH1gaTqTBgQX2b1YRLVIlFdQfDCHLcWzRdxO7pCJlcV0aqaeYEJSABoXS'}
        #     # yo = requests.post(url,headers=headers,data=json.dumps(my_objs))
        #     print(my_objs)

        #     # Thank you message after answering all question
        #     speak_output = "Got it. Your feedback is extremely valuable to us. Thank you for your participation in survey.Have a wonderful day!"
        ...
        #     )
            ...
            reprompt = language_prompts["QUESTION_INTENT_REPROMPT"]
            try:  
                ...
                if str(question_type_id) == MCQwithmultipleselection:
                    ...
                    # speak_output = (str(language_prompts["MCQ_WITH_MULTIPLE_QUESTION_PROMPT"])).format(question_text=attr["question_text"],mcq_options=options_speak_output)
                    ...
                    speak_output = (str(language_prompts["MCQ_WITH_MULTIPLE_QUESTION_PROMPT"])).format(question_text=attr["question_text"],mcq_options=mcq_options)
                    # if str(is_other) == "0":
                    ...
                    speak_output = (str(language_prompts["DESCRIPTIVE_QUESTION_PROMPT"])).format(question_text=attr["question_text"]) + " You can take your time to think about answer. Start your answer with 'Alexa Answer is' :  <audio src= 'https://aaudiobucket.s3.eu-west-1.amazonaws.com/Trimmed_calm_music.mp3'/>"
                    attr["counter"] += 1
                elif str(question_type_id) == ShortAnswer:
                    handler_input.attributes_manager.session_attributes = attr
                    speak_output=  (str(language_prompts["SHORT_ANSWER_QUESTION_PROMPT"])).format(question_text=attr["question_text"])
                    attr["counter"] += 1
                    ...
                    # Code for speak output as option a- option text
                    # if str(is_other) == "0":
                    #     attr["mcq_options"] = mcq_options
                    # else :
                    ...
                    if str(is_other) == "0":
                        ...
                        speak_output = (str(language_prompts["MCQ_WITH_SINGLE_SELECTION_PROMPT"])).format(question_text=attr["question_text"],mcq_options=mcq_options)
                    else: 
                        mcq_options.append("other")
                        attr["mcq_options"] = mcq_options
                    ...
                    if str(is_other)=="0":
                        ...
                        speak_output = (str(language_prompts["MCQ_WITH_SINGLE_SELECTION_PROMPT"])).format(question_text=attr["question_text"],mcq_options=mcq_options) + " Other"  
                    attr["counter"] += 1
                    ...
                    speak_output = (str(language_prompts["RATING_QUESTION_PROMPT"])).format(rating_range = rating_range,question_text=attr["question_text"])
                    attr["counter"] += 1
                    ...
                    speak_output = (str(language_prompts["GROUP_RATING_QUESTION_PROMPT_1"])).format(rating_range = rating_range,question_text=attr["question_text"], rating_group=rating_groups[0] )
                    attr["counter"] += 1
                # Condition for prompt last question as general feedback question
                elif str(question_type_id) == "general_feedback" :
                    speak_output = attr["question_text"]
                    attr["feedback"] = True
                    attr["counter"] += 1
                else:
                    dictionary.clear()
                    ...
                    speak_output =  (str(language_prompts["EXCEPTION_QUESTION_TEXT_PROMPT"])).format(question_text=attr["question_text"],mcq_options=mcq_options)
                    attr["counter"] += 1 
            except IndexError:
                lang = handler_input.request_envelope.request.locale
                time_zone = get_timezone_based_ty_msg(lang)
                global survey_owner_ty_msg
                if survey_owner_ty_msg == None :
                    speak_output = (str(language_prompts["THANK_YOU_PROMPT"])).format(time_zone=time_zone)
                else :
                    survey_owner_ty_msg = re.sub("<[^>]*>","",survey_owner_ty_msg)
                    speak_output = survey_owner_ty_msg

                # Code for posting Answer of last question 
                if user_response != None and report_question_intent != True and not attr["feedback"]:
                ...
                elif attr["feedback"] and attr["intent_history"] == "FeedbackIntent" and user_response != None :
                    # we will take user answer and post it in feedback API and prompt thank you message 
                    my_objs = {
                    "isSurvey": 1,
                    "name": "alexa",
                ...
                if  report_question_intent and intent_lst[-1] != "HelpExitIntent": #intent_lst[-2] == "ReportQuestionIntent"
                    speak_output1 = str(language_prompts["LAST_QUESTION_REPORT_PROMPT"])
                ...
                if user_response != None and report_question_intent != True and attr["intent_history"] != "AMAZON.NextIntent":
                    if attr["counter"] > 1:
            ...
            if  report_question_intent and intent_lst[-1] != "HelpExitIntent" and intent_lst[-1] != "AMAZON.ResumeIntent": #intent_lst[-2] == "ReportQuestionIntent"
                speak_output1 = str(language_prompts["REPORT_QUESTION_COMMENT_PROMPT"])
    ...
    def handle(self, handler_input):
        ...
        if attr["question_type"] == Rating :
            ...
            try:
                ...
                speak_output = (str(language_prompts["GROUP_RATING_QUESTION_PROMPT_2"])).format(group_option_text=group_option_text)
            ...
            speak_output = language_prompts["WRONG_RESPONSE_PROMPT"]
...
class SupportIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        attr = handler_input.attributes_manager.session_attributes
        language_prompts = handler_input.attributes_manager.request_attributes["_"]
        speak_output = language_prompts["SUPPORT_INTENT_PROMPT"]
...
class FallbackIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        attr = handler_input.attributes_manager.session_attributes
        language_prompts = handler_input.attributes_manager.request_attributes["_"]
        speech = language_prompts["FALLBACK_INTENT_PROMPT"]
        reprompt = language_prompts["FALLBACK_INTENT_REPROMPT"]
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = language_prompts["HELP_INTNET_PROMPT"]
        return (
            handler_input.response_builder
                .speak(speak_output)
                .ask(speak_output)
...
class HelpExitIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if attr.get("session_state") == None :
            speak_output = language_prompts["VALID_SURVEY_CODE_PROMPT"]
        else :
            attr["counter"] -= 1
            speak_output = str(language_prompts["EXIT_HELP_INTENT_PROMPT_2"])
...
class RepeatIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if attr.get("help_intent"):
            speak_output = language_prompts["REPEAT_INTENT_PROMPT"]
        else :
...
class HomeIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        language_prompts = handler_input.attributes_manager.request_attributes["_"]
        if attr.get("help_intent"):
            speak_output = language_prompts["HOME_INTENT_PROMPT"]
...
class ResumeIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        language_prompts = handler_input.attributes_manager.request_attributes["_"]
        if attr.get("help_intent"):
            speak_output = language_prompts["RESUME_INTENT_PROMPT_1"]
        elif attr.get("session_state") == None :
            speak_output = language_prompts["VALID_SURVEY_CODE_PROMPT"]
        else :
            attr["counter"] -= 1
            speak_output = str(language_prompts["RESUME_INTENT_PROMPT_3"])
            speak_output_QuestionIntent = QuestionIntentHandler().handle(handler_input).output_speech.ssml.replace("<speak>","").replace("</speak>","")
            speak_output = speak_output + speak_output_QuestionIntent
...
class StopIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = (str(language_prompts["STOP_INTENT_PROMPT"])).format(time_zone)
...
class CancelIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        language_prompts = handler_input.attributes_manager.request_attributes["_"]
        if attr.get("help_intent"):
            speak_output = language_prompts["CANCEL_INTENT_PROMPT_1"]
        elif attr.get("session_state") == None :
            speak_output = language_prompts["VALID_SURVEY_CODE_PROMPT"]
        elif attr["intent_history"][-2] == "ReportQuestionIntent" or attr["intent_history"][-2] == "ReportSurveyIntent":
            attr["counter"] -= 1
            speak_output = language_prompts["RESUME_INTENT_PROMPT_3"] 
            speak_output_QuestionIntent = QuestionIntentHandler().handle(handler_input).output_speech.ssml.replace("<speak>","").replace("</speak>","")
            speak_output = speak_output + speak_output_QuestionIntent
        else :
            speak_output = language_prompts["CANCEL_INTENT_PROMPT_3"]
...
class ReportQuestionIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        attr["question_type"] = ""
        if attr.get("help_intent") :
            speak_output = language_prompts["REPORT_QUESTION_INTENT_PROMPT_1"]
        elif attr.get("session_state") == None :
            speak_output = language_prompts["VALID_SURVEY_CODE_PROMPT"]
        elif attr["feedback"] :
            speak_output =  language_prompts["REPORT_QUESTION_INTENT_PROMPT_2"]
        else :
            speak_output =  language_prompts["REPORT_QUESTION_INTENT_PROMPT_3"]
...
class ReportSurveyIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        attr["question_type"] = ""
        if attr.get("help_intent") :
            speak_output = language_prompts["REPORT_SURVEY_INTENT_PROMPT_1"]
        elif attr.get("session_state") == None :
            speak_output = language_prompts["VALID_SURVEY_CODE_PROMPT"]
        else :
            speak_output = language_prompts["REPORT_SURVEY_INTENT_PROMPT_2"]
...
class FeedbackIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        attr = handler_input.attributes_manager.session_attributes
        language_prompts = handler_input.attributes_manager.request_attributes["_"]
        feedback_var = get_slot_value(handler_input=handler_input, slot_name="FeedbackType")
        if (feedback_var == "yes" or feedback_var == "yes i want to share feedback" or feedback_var == "yes i want to share my thoughts") and attr["feedback"]:
            # Logic for yes
            speak_output = language_prompts["FEEDBACK_INTENT_PROMPT"]
        ...
        elif (feedback_var == "no" or feedback_var == "no feedback") and attr["feedback"]:
            # Logic for no
            lang = handler_input.request_envelope.request.locale
            time_zone = get_timezone_based_ty_msg(lang)
            global survey_owner_ty_msg
...
class SkipIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if attr.get("session_state") == None :
            ...
            speak_output = language_prompts["SKIP_INTENT_PROMPT_1"]
            ...
            speak_output = language_prompts["SKIP_INTENT_PROMPT_2"]
            ...
            if len_survey == attr["counter"] :
                # Posting Static Word "SKIP" in response API if user Skip particular QuestionIntentHandler
                # Fetching required Data for posting in API
                ids=(datass[attr["counter"]-1]["question_id"])
                _id=(datass[attr["counter"]-1]["id"])
                survey_id=(datass[attr["counter"]-1]["survey_id"])
                ...
                "response_text": "SKIP",
                "device_id": device_id }
                # print(question_textss)
                # r = posting_responses(myobjs)

                speak_output = str(language_prompts["SKIP_INTENT_PROMPT_3"]) + QuestionIntentHandler().handle(handler_input).output_speech.ssml.replace("<speak>","").replace("</speak>","")
                speak_output = str(language_prompts["SKIP_INTENT_PROMPT_4"])+ QuestionIntentHandler().handle(handler_input).output_speech.ssml.replace("<speak>","").replace("</speak>","")
...
class IntentReflectorHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if speak_output == "You just triggered SurveyIntent.":
            if attr.get("help_intent"):
                speak_output = language_prompts["INTENT_REFLECTOR_PROMPT_1"]
...
class LocalizationInterceptor(AbstractRequestInterceptor):
    ...
    def process(self, handler_input):
        ...
        try:
            ...
            with open("languages/en-US.json") as language_data:
                language_prompts = json.load(language_data)
...
sb.add_request_handler(RatingTypeIntentHandler()) 
